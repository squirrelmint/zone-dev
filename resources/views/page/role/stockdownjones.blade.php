...
@section('content')
    <div class="col-12 col-md-9">
        <div class="h-100 zone-background zone-reward zone-content">
            <img src="{{asset('img/reward/banner-stockdownjones.png')}}">

            <h1 class="zone-contact-title-gradient">หวยหุ้นดาวโจนส์</h1>
            <h2 class="zone-contact-title">หวยหุ้นดาวโจนส์ กติกาการเเทง AMBLOTTO</h2>
...
ถือว่าไม่มีการออกผลรางวัล</li>
            ...
            <h2 class="zone-contact-title">วิธีการดูผลหวยหุ้นดาวโจนส์</h2>
            <ul>
