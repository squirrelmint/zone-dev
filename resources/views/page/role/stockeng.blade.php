...
@section('content')
    <div class="col-12 col-md-9">
        <div class="h-100 zone-background zone-reward zone-content">
            <img src="{{asset('img/reward/banner-stockeng.png')}}">

            <h1 class="zone-contact-title-gradient">หวยหุ้นอังกฤษ</h1>
            <h2 class="zone-contact-title">หวยหุ้นอังกฤษ กติกาการเเทง AMBLOTTO</h2>
...
ถือว่าไม่มีการออกผลรางวัล</li>
            ...
            <h2 class="zone-contact-title">วิธีการดูผลหวยหุ้นอังกฤษ</h2>
            <ul>
