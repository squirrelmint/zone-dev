...
@section('content')
    <div class="col-12 col-md-9">
        <div class="h-100 zone-background zone-reward zone-content">
            <img src="{{asset('img/reward/banner-stockkorea.png')}}">
            <h1 class="zone-contact-title-gradient">หวยหุ้นเกาหลี</h1>
            <h2 class="zone-contact-title">หวยหุ้นเกาหลี กติกาการเเทง ZONELOTTO</h2>
            ...
            <ul>
                ...
                <li>ปิดรับเเทงรอบสุดท้าย เวลา 12:40 น.</li>
                <li>ระบบทำการคืนโพยเเละเครดิตให้ในกรณีที่ตลาดหุ้นไม่มีความเคลื่อนไหวใดๆ ภายใน 1 ชั่วโมง
ถือว่าไม่มีการออกผลรางวัล</li>
            </ul>

            <h2 class="zone-contact-title">วิธีการดูผลหวยหุ้นเกาหลี</h2>
            <ul>
                <li>ใช้ผลปิดตลาดหุ้น Korea Exchange ให้ค่า KTOP 30</li>
