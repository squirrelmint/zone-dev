...
@section('content')
    <div class="col-12 col-md-9">
        <div class="h-100 zone-background zone-reward zone-content">
            <img src="{{asset('img/reward/banner-stocknikkei.png')}}">

            <h1 class="zone-contact-title-gradient">หวยหุ้นนิเคอิ</h1>
            <h2 class="zone-contact-title">หวยหุ้นนิเคอิ กติกาการเเทง ZONELOTTO</h2>
            ...
            <h2 class="zone-contact-title">วิธีการดูผลหวยหุ้นนิเคอิ</h2>
            <ul>
